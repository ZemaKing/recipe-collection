...
function AdminIngredientsPage() {
  ...
  const visible = useMemo(() => {
    ...
    return [...filtered].sort(
      (a, b) =>
        pickLocalized(a.name_en, a.name_sr, lang).localeCompare(
          pickLocalized(b.name_en, b.name_sr, lang),
        ) * direction,
    )
  ...
  return (
    <div className="flex flex-col gap-4">
              ...
              <thead>
                <tr className="border-b border-border text-left text-xs font-medium tracking-wide text-muted-foreground uppercase">
                  <th className="w-16 px-4 py-3 font-medium">
                    {t('admin.ingredients.columnImage')}
                  </th>
                  ...
                  <th className="px-4 py-3 text-right font-medium">
                    {t('admin.ingredients.columnActions')}
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border">
                {visible.map((ingredient) => {
                  ...
                  const badgeColor = ingredient.ingredient_category
                    ...
                    : null
                  const editHref = buildLocalizedPath(
                    lang,
                    `/admin/sastojci/${ingredient.slug}/izmeni`,
                  )
      ...
      <DeleteIngredientDialog
        ingredientName={
          pendingDelete ? pickLocalized(pendingDelete.name_en, pendingDelete.name_sr, lang) : null
        }
