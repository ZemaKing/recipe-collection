...
export const RECIPE_SUMMARY_SELECT =
  'id, slug, name_en, name_sr, prep_time_minutes, cook_time_minutes, rating, is_favorite, difficulty, category:categories(slug, name_en, name_sr), subcategory:subcategories(slug, name_en, name_sr), images:recipe_images(storage_path, alt_en, alt_sr, is_primary)'
